					...
					<table id="tb_voucher" class="table table-sm table-bordered table-striped" style="font-size: 15px;width:100%;">
						<thead class="thead-dark text-center">
							<tr>
								...
								<th style="font-size: 15px;" class="align-middle">Expired At</th>
										...
										<div class="row">
											<div class="form-group col-6">
												...
												<div class="input-group">
													...
													<input type="text" class="js-maxlength form-control" id="kode_voucher" name="kode_voucher" maxlength="35" placeholder="Masukkan kode voucher" data-always-show="true" data-warning-class="badge badge-primary" data-limit-reached-class="badge badge-primary" required>
												</div>
											</div>
											<div class="form-group col-6">
												...
												<div class="input-group">
													...
													<input type="text" class="js-maxlength form-control" maxlength="20" id="rupiah" name="nilai" placeholder="Masukkan nilai voucher" data-always-show="true" data-warning-class="badge badge-primary" data-limit-reached-class="badge badge-primary" required>   
												</div>
											</div>
											<div class="form-group col-6">
												<label for="">Tanggal Expired</label><br>
												<div class="input-group">
													<div class="input-group-prepend">
														<span class="input-group-text text-white" style="background-color: #7750b1;"><i class="fa fa-calendar-alt"></i>
														</span>
													</div>
													<input type="text" class="js-datepicker form-control" name="expired_at" id="expired_at" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="dd-mm-yyyy" placeholder="Tanggal Expired" autocomplete="off" required>   
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="form-group col-6">
												...
												<div class="input-group">
													...
													<input type="text" class="js-maxlength form-control" id="kode_voucher_edit" name="kode_voucher_edit" maxlength="35" placeholder="Masukkan kode voucher" data-always-show="true" data-warning-class="badge badge-primary" data-limit-reached-class="badge badge-primary" required>
												</div>
											</div>
											<div class="form-group col-6">
												<label for="">Nilai Voucher</label><br>
												<div class="input-group">
													...
													<input type="text" class="js-maxlength form-control" maxlength="20" id="nilai_edit" name="nilai_edit" placeholder="Masukkan nilai voucher" data-always-show="true" data-warning-class="badge badge-primary" data-limit-reached-class="badge badge-primary" required>   
												</div>
											</div>
											<div class="form-group col-6">
												<label for="">Tanggal Expired</label><br>
												<div class="input-group">
													...
													<input type="text" class="js-datepicker form-control" name="expired_at_edit" id="expired_at_edit" data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="dd-mm-yyyy" placeholder="Tanggal Expired" autocomplete="off" required>   
												</div>
											</div>
										</div>
