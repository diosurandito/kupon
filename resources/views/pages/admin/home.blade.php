                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="js-maxlength form-control" maxlength="17" id="rupiah" name="ttl_transaksi" placeholder="Total transaksi" data-always-show="true" data-warning-class="badge badge-primary" data-limit-reached-class="badge badge-primary" required>   
                                    </div>
                                </div>
                            </div>
